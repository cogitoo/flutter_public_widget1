                    ...
                    Center(
                      child: Container(
                        decoration: BoxDecoration(
                          ...
                          //设置四周边框
                          border:  Border.all(width: 1, color: HexColor('#ECECEC')),
...
//背景
                          ...
                          child: Row(
                            children: [
                              ...
                              }, icon: Image.asset('assets/showps.png',width: 15,height: 15,))
                            ],
                          )
                      ),
                    ),
                      ...
                      child: Row(
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child:  Text('注册账号'.tr,style: TextStyle(fontSize: 14,color: Theme.of(context).primaryColor),),
                            onTap: (){
                              // Get.to(RegisterPage());
                            },
                          ),
                          ...
                          //  ),
                          GestureDetector(
                            child: Text('帮助手册'.tr,style: TextStyle(fontSize: 14,color: Theme.of(context).primaryColor),),
                            onTap: (){
                              // Get.to(MyWebView(title: '使用说明',url: 'https://docs.qq.com/doc/DZmFZYVVKTldOQ3dp',));
                              Get.to(MyWebView('使用说明', 'https://docs.qq.com/doc/DZmFZYVVKTldOQ3dp'));
                    ...
                    Container(
                      margin: EdgeInsets.only(top: 62, right: 15, left: 15),
                      width: Get.width,
                      height: 45,
                      child:
                      RaisedButton(
                        ...
                        onPressed: () async {
                          logic.requestDataWithLogin(usernameTF.text,passwordTF.text);
                    ...
                    Container(
                      ...
                      child:Row(
                        ...
                        children: [
                          Text('阅读',style: TextStyle(fontSize: 12,color: HexColor('#333333')),),
                          GestureDetector(
                            onTap: (){
                              // Get.to();
                            },
                            child: Text('《用户协议》《个人信息保护政策》',style: TextStyle(fontSize: 12,color: Theme.of(context).primaryColor),),
                          )
                        ],
                      ),
                    )
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Image.asset('assets/supstar_icon.png',width: 50,height: 50,),
